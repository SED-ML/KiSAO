...
source_dir = os.path.join(os.path.dirname(__file__), '..', 'kisao')
sys.path.insert(0, os.path.join(os.path.dirname(__file__), '..'))

# -- Project information -----------------------------------------------------
source_base_url = 'https://github.com/SED-ML/KiSAO/blob/dev/'
project = 'KiSAO'
copyright = '{}, SED-ML Editors'.format(datetime.datetime.now().year)
...
html_theme_options = {
    ...
    'github_banner': True,
    'github_button': True,
    'description': 'Utilities for working with KiSAO in Python',
    'fixed_sidebar': True,
    'show_powered_by': False,
    'show_relbars': False,
    'extra_nav_links': {
        'KiSAO': 'https://co.mbine.org/standards/kisao',
    }
}
